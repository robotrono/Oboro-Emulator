...
struct s_skill_db {
	...
	int oboro_delay150; //oboro_delay at 150 aspd
	int oboro_delay190; //oboro_delay at 190 aspd
	int oboro_SkillType; //oboro_skill_type
};
...
enum {
	...
	UF_RANGEDSINGLEUNIT = 0x1000,	// To display one unit in the client only. iSaaC
};
