	...
	{ // Homunculus Backup
		...
		if( mapif_homunculus_load(cp.hom_id, &hd) )
		{
			...
			fprintf(fp, "INSERT INTO `homunculus` "
				...
				cp.char_id, hd.class_, hd.class_, esc_name, hd.level, hd.exp, hd.intimacy, hd.hunger, hd.str, hd.agi, hd.vit, hd.int_, hd.dex, hd.luk, hd.hp, hd.max_hp, hd.sp, hd.max_sp, hd.skillpts, hd.rename_flag, hd.vaporize);
