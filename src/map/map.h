...
#define MAX_LEVEL 99 // 3erd jobs change this for 150 isaac..
...
//WOESHOP BY ISAAC
enum npc_subtype { WARP, SHOP, SCRIPT, CASHSHOP, SPSHOP, WOESHOP, COSTUMESHOP };
...
struct map_data {
	...
	struct map_flag {
		...
		unsigned nodiscount : 1; //iSaaC no descuento, creado para mapa de bg custom telma
