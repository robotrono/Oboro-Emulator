...
static int map_cell2gat(struct mapcell cell)
{
	...
	else if( cell.walkable == 0 && cell.shootable == 0 && cell.water == 0 ) return 1;
	else if( cell.walkable == 1 && cell.shootable == 1 && cell.water == 1 ) return 3;
	else if( cell.walkable == 0 && cell.shootable == 1 && cell.water == 0 ) return 5;
