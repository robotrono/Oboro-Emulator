...
Source Server         : `xro test
Source Server Version : 50173
Source Host           : 158.69.153.131:3306
...
-- ----------------------------
-- Table structure for cp_injectprotection
-- ----------------------------
DROP TABLE IF EXISTS `cp_injectprotection`;
CREATE TABLE `cp_injectprotection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `php` varchar(25) NOT NULL DEFAULT 'default.php',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- ----------------------------
-- Table structure for cp_memberlog
-- ----------------------------
DROP TABLE IF EXISTS `cp_memberlog`;
CREATE TABLE `cp_memberlog` (
...
-- ----------------------------
-- Table structure for cp_sstatuslog
-- ----------------------------
DROP TABLE IF EXISTS `cp_sstatuslog`;
CREATE TABLE `cp_sstatuslog` (
...
-- ----------------------------
-- Table structure for donaciones_items
-- ----------------------------
DROP TABLE IF EXISTS `donaciones_items`;
CREATE TABLE `donaciones_items` (
  `donation_id` int(10) unsigned NOT NULL,
  `item_id` int(10) unsigned NOT NULL,
  `amount` int(10) unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`donation_id`,`item_id`,`amount`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `login` (
  ...
  KEY `name` (`userid`)
) ENGINE=InnoDB AUTO_INCREMENT=2000000 DEFAULT CHARSET=latin1 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC;
