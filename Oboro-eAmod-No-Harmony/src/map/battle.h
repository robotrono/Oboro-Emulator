...
// eAthena additions
	...
	int use_aegis_land_shower; //iSaaC arrow shower fix
	...
	int min_guild; //isaac
	int vending_cash_tax; //isaac

	int oboro_tol;
	int oboro_tol2;
	int oboro_incr;
	int oboro_enable;
	int oboro_max_hitlock_count;
	int oboro_hitlock_incr;
	int oboro_reduce_hitlock_on_correct;
	int oboro_reduce_hitlock_on_hitlock;
	int oboro_reduce_hackcount_on_correct;
	int oboro_reduce_hackcount_on_hitlock;
	int oboro_fixeddelay_tol;
	int oboro_buffer_size;
	int oboro_max_infixed;
	int oboro_buffer_time;
